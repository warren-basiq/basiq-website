...
const INTRO =
  "Engagement model: map the highest-leverage entry points, prove them with working prototypes, build the infrastructure in production, then hand off the keys. Basiq also ships its own products (e.g. Qenerate) and runs hands-on AI masterclasses.";
